...
{ id: "GANDALF", group: 24, label: "GANDALF", level: 1, color: "green" },
{ id: "GIMLI", group: 25, label: "GIMLI", level: 1, color: "green" },
{ id: "LEGOLAS", group: 26, label: "LEGOLAS", level: 1, color: "green" },
{ id: "DUMBLEDORE", group: 27, label: "DUMBLEDORE", level: 1, color: "green" },
{ id: "HERMIONE GRANGER", group: 28, label: "HERMIONE GRANGER", level: 1, color: "green" },
...
{ id: "SAMUS ARAN", group: 41, label: "SAMUS ARAN", level: 1, color: "green" },
{ id: "FOX", group: 42, label: "FOX", level: 1, color: "green" },
{ id: "BOBA FETT", group: 43, label: "BOBA FETT", level: 1, color: "green" },
{ id: "STAR WARS", group: 44, label: "STAR WARS", level: 1, color: "green" },
{ id: "STAR", group: 45, label: "STAR", level: 1, color: "green" },
{ id: "STAR TREK", group: 46, label: "STAR TREK", level: 1, color: "green" },
{ id: "DARTH VADER", group: 47, label: "DARTH VADER", level: 1, color: "green" },
{ id: "LUKE SKYWALKER", group: 48, label: "LUKE SKYWALKER", level: 1, color: "green" },
{ id: "JET BLACK", group: 49, label: "JET BLACK", level: 1, color: "green" },
{ id: "SPIKE SPIEGEL", group: 50, label: "SPIKE SPIEGEL", level: 1, color: "green" },
{ id: "FAYE VALENTINE", group: 51, label: "FAYE VALENTINE", level: 1, color: "green" },
{ id: "HIPPO", group: 52, label: "HIPPO", level: 1, color: "green" },
{ id: "PENNY", group: 53, label: "PENNY", level: 1, color: "green" },
{ id: "QUARTER", group: 54, label: "QUARTER", level: 1, color: "green" },
{ id: "NICKEL", group: 55, label: "NICKEL", level: 1, color: "green" },
{ id: "SUN", group: 56, label: "SUN", level: 1, color: "green" },
{ id: "SIRIUS", group: 57, label: "SIRIUS", level: 1, color: "green" },
{ id: "PERCY WEASLEY", group: 58, label: "PERCY WEASLEY", level: 1, color: "green" },
{ id: "SIRIUS BLACK", group: 59, label: "SIRIUS BLACK", level: 1, color: "green" },
{ id: "BELLATRIX BLACK", group: 60, label: "BELLATRIX BLACK", level: 1, color: "green" },
{ id: "MERLIN", group: 61, label: "MERLIN", level: 1, color: "green" },
{ id: "CEDRIC DIGGORY", group: 62, label: "CEDRIC DIGGORY", level: 1, color: "green" },
{ id: "BATMAN", group: 63, label: "BATMAN", level: 1, color: "green" },
{ id: "EDWARD CULLEN", group: 64, label: "EDWARD CULLEN", level: 1, color: "green" },
{ id: "BLACK", group: 65, label: "BLACK", level: 1, color: "green" },
{ id: "JACOB BLACK", group: 66, label: "JACOB BLACK", level: 1, color: "green" },
...
{ id: "PRINCESS CELESTIA", group: 72, label: "PRINCESS CELESTIA", level: 1, color: "green" },
{ id: "MOON", group: 73, label: "MOON", level: 1, color: "green" },
{ id: "PRINCESS", group: 74, label: "PRINCESS", level: 1, color: "green" },
{ id: "TWILIGHT", group: 75, label: "TWILIGHT", level: 1, color: "green" },
{ id: "BELLA SWAN", group: 76, label: "BELLA SWAN", level: 1, color: "green" },
{ id: "VAMPIRE", group: 77, label: "VAMPIRE", level: 1, color: "green" },
{ id: "WEREWOLF", group: 78, label: "WEREWOLF", level: 1, color: "green" },
{ id: "NEW MOON", group: 79, label: "NEW MOON", level: 1, color: "green" },
{ id: "ECLIPSE", group: 80, label: "ECLIPSE", level: 1, color: "green" },
{ id: "WHEEL OF FORTUNE", group: 81, label: "WHEEL OF FORTUNE", level: 1, color: "green" },
{ id: "WORLD", group: 82, label: "WORLD", level: 1, color: "green" },
{ id: "FORTUNE", group: 83, label: "FORTUNE", level: 1, color: "green" },
{ id: "MUSHU", group: 84, label: "MUSHU", level: 1, color: "green" },
{ id: "SNOW WHITE", group: 85, label: "SNOW WHITE", level: 1, color: "green" },
{ id: "MERCURY", group: 86, label: "MERCURY", level: 1, color: "green" },
{ id: "GEMINI", group: 87, label: "GEMINI", level: 1, color: "green" },
{ id: "MOCKINGJAY", group: 88, label: "MOCKINGJAY", level: 1, color: "green" },
{ id: "PRESIDENT SNOW", group: 89, label: "PRESIDENT SNOW", level: 1, color: "green" },
{ id: "PEETA", group: 90, label: "PEETA", level: 1, color: "green" },
{ id: "POWER", group: 91, label: "POWER", level: 1, color: "green" },
{ id: "COURAGE", group: 92, label: "COURAGE", level: 1, color: "green" },
{ id: "WISDOM", group: 93, label: "WISDOM", level: 1, color: "green" },
{ id: "DND STATS", group: 94, label: "DND STATS", level: 1, color: "green" },
{ id: "STRENGTH", group: 95, label: "STRENGTH", level: 1, color: "green" },
{ id: "INTELLIGENCE", group: 96, label: "INTELLIGENCE", level: 1, color: "green" },
{ id: "CONSTITUTION", group: 97, label: "CONSTITUTION", level: 1, color: "green" },
{ id: "POWERPUFF GIRLS", group: 98, label: "POWERPUFF GIRLS", level: 1, color: "green" },
{ id: "BUTTERCUP", group: 99, label: "BUTTERCUP", level: 1, color: "green" },
{ id: "BUBBLES", group: 100, label: "BUBBLES", level: 1, color: "green" },
{ id: "BLOSSOM", group: 101, label: "BLOSSOM", level: 1, color: "green" },
{ id: "MOJO JOJO", group: 102, label: "MOJO JOJO", level: 1, color: "green" },
{ id: "PUFF", group: 103, label: "PUFF", level: 1, color: "green" },
{ id: "PUFF THE MAGIC DRAGON", group: 104, label: "PUFF THE MAGIC DRAGON", level: 1, color: "green" },
{ id: "DC SUPER HERO GIRLS", group: 105, label: "DC SUPER HERO GIRLS", level: 1, color: "green" },
{ id: "WONDER WOMAN", group: 106, label: "WONDER WOMAN", level: 1, color: "green" },
{ id: "BATGIRL", group: 107, label: "BATGIRL", level: 1, color: "green" },
{ id: "ZATANNA", group: 108, label: "ZATANNA", level: 1, color: "green" },
{ id: "SUPERGIRL", group: 109, label: "SUPERGIRL", level: 1, color: "green" },
{ id: "DC", group: 110, label: "DC", level: 1, color: "green" },
{ id: "SUPERMAN", group: 111, label: "SUPERMAN", level: 1, color: "green" },
{ id: "SHAZAM", group: 112, label: "SHAZAM", level: 1, color: "green" },
{ id: "SOLOMON", group: 113, label: "SOLOMON", level: 1, color: "green" },
{ id: "HERCULES", group: 114, label: "HERCULES", level: 1, color: "green" },
{ id: "ATLAS", group: 115, label: "ATLAS", level: 1, color: "green" },
{ id: "ZEUS", group: 116, label: "ZEUS", level: 1, color: "green" },
{ id: "ACHILLES", group: 117, label: "ACHILLES", level: 1, color: "green" },
{ id: "GREEK MYTHOLOGY", group: 118, label: "GREEK MYTHOLOGY", level: 1, color: "green" },
